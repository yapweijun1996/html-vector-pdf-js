...
const PLACEHOLDERS = [
    ...
    { constName: 'EMBEDDED_FONT_DATA_CARLITO_NORMAL', placeholder: 'EMBEDDED_FONT_DATA_CARLITO_NORMAL_PLACEHOLDER' },
    { constName: 'EMBEDDED_FONT_DATA_CARLITO_BOLD', placeholder: 'EMBEDDED_FONT_DATA_CARLITO_BOLD_PLACEHOLDER' },
    { constName: 'EMBEDDED_FONT_DATA_LIBERATIONSANS_NORMAL', placeholder: 'EMBEDDED_FONT_DATA_LIBERATIONSANS_NORMAL_PLACEHOLDER' },
    { constName: 'EMBEDDED_FONT_DATA_LIBERATIONSANS_BOLD', placeholder: 'EMBEDDED_FONT_DATA_LIBERATIONSANS_BOLD_PLACEHOLDER' },
    { constName: 'EMBEDDED_FONT_DATA_NOTOSANSSYMBOLS2_NORMAL', placeholder: 'EMBEDDED_FONT_DATA_NOTOSANSSYMBOLS2_NORMAL_PLACEHOLDER' }
];

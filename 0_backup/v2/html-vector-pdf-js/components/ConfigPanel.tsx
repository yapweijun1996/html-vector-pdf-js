...
import { Settings, FileText, Download, Layout, Type } from 'lucide-react';
...
const ConfigPanel: React.FC<ConfigPanelProps> = ({ config, onConfigChange, onExport, isExporting }) => {
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-2">
                <button
                  ...
                  className={`px-3 py-2 text-sm rounded-md border ${config.orientation === 'portrait'
                ...
                <button
                  ...
                  className={`px-3 py-2 text-sm rounded-md border ${config.orientation === 'landscape'
                    ? 'bg-blue-50 border-blue-500 text-blue-700'
                    : 'bg-white border-slate-300 hover:bg-slate-50'
                    }`}
                >
